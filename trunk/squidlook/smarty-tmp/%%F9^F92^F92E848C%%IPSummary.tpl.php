<?php /* Smarty version 2.6.10, created on 2006-07-25 09:45:10
         compiled from IPSummary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'bytesToHRF', 'IPSummary.tpl', 79, false),)), $this); ?>
...
&Servizio=<?php echo $this->_tpl_vars['pageVars']['Servizio']; ?>
" title="List of all the different sites that were visited">Riassunto siti visitati in un giorno specifico</a> ]
...
" src="images/up-arrow.gif"></a>
          <?php echo $this->_tpl_vars['pageVars']['usernameLabelStart']; ?>
Nome utente<?php echo $this->_tpl_vars['pageVars']['usernameLabelEnd']; ?>
...
&hostiplong=<?php echo $this->_tpl_vars['record']['hostiplong']; ?>
&usersID=<?php echo $this->_tpl_vars['record']['usersID']; ?>
&elapsedTime=0'><?php echo $this->_tpl_vars['record']['username']; ?>
</td>
      <td><a href='<?php echo $_SERVER['PHP_SELF']; ?>
?a=IPSitesSummary&minDate=<?php echo $this->_tpl_vars['pageVars']['minDate']; ?>
&maxDate=<?php echo $this->_tpl_vars['pageVars']['maxDate']; ?>
