...
<p>
[ <a href="{$smarty.server.PHP_SELF}?a=allsites&minDate={$pageVars.minDate}&maxDate={$pageVars.maxDate}" title="List of all the different sites that were visited">Riassunto siti visitati in questo periodo</a> ]
...
<center>
  <table>
    ...
    {foreach from=$pageVars.groupIPRecords item=record}
    ...
    <tr onMouseOver="this.bgColor='#C5D3E7';" onMouseOut="this.bgColor='#DAE3F0';">
      ...
      <td><a href='{$smarty.server.PHP_SELF}?a=IPSummary&minDate={$pageVars.minDate}&maxDate={$pageVars.maxDate}&hostiplong={$record.hostiplong}&Servizio={$record.servizio}&elapsedTime=0'>{$record.servizio}</td>
      <td><a href='{$smarty.server.PHP_SELF}?a=allsites&minDate={$pageVars.minDate}&maxDate={$pageVars.maxDate}&Servizio={$record.servizio}'>{$record.sites}</td>
